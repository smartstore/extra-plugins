...
namespace SmartStore.MailChimp.Models
{
    public class MailChimpSettingsModel
    {
        ...
        /// The API key.
        /// </value>
        [SmartResourceDisplayName("Plugins.Misc.MailChimp.ApiKey")]
        ...
        /// The web hook key.
        /// </value>
        [SmartResourceDisplayName("Plugins.Misc.MailChimp.WebHookKey")]
        ...
        /// The default list id.
        /// </value>
        [SmartResourceDisplayName("Plugins.Misc.MailChimp.DefaultListId")]
        ...
        /// </value>
        [SmartResourceDisplayName("Plugins.Misc.MailChimp.AutoSync")]
        public virtual bool AutoSync { get; set; }

        [SmartResourceDisplayName("Plugins.Misc.MailChimp.AutoSyncEachMinutes")]
